...
class Solver:
    ...
    def phi11(self, x1, x2):
        return 1 - (self.f11(x1) * self.lmbd[0, 0] + self.f21(x1) *
                    self.lmbd[0, 1])
    ...
    def phi21(self, x1, x2):
        return -(self.f11(x1) * self.lmbd[1, 0] + self.f21(x1) *
                 self.lmbd[1, 1])
    ...
    def j(self, x1, x2):
        return [[self.f11(x1), self.f12(x1)], [self.f21(x1), self.f22(x2)]]
